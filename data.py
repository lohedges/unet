...
def trainGenerator(batch_size, train_path, image_folder, mask_folder, aug_dict, image_color_mode="grayscale",
    ...
    train_gen = (adjustData(img, mask) for img, mask in zip(image_generator, mask_generator))
    valid_gen = (adjustData(img, mask) for img, mask in zip(val_image_generator, val_mask_generator))
